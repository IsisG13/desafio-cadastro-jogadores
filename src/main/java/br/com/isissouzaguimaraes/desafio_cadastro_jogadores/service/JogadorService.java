...
import br.com.isissouzaguimaraes.desafio_cadastro_jogadores.repository.JogadorRepository;
...
public class JogadorService {
    ...
    public Jogador registrarJogador(Jogador jogador) throws Exception {
        ...
        var novoJogador = new Jogador(jogador.nome(), jogador.email(), jogador.telefone(), novoCodinome,
    ...
    private List<String> listarCodinomesEmUso(GrupoCodinome grupoCodinome) {
        return jogadorRepository.listarCodinomesEmPorGrupo(grupoCodinome);
    }
}
